...
<html>
  <head>
    ...
    <title>ERP Solution | Dashboard</title>
                  ...
                  <div class="box-tools pull-right">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="{!! url('#') !!}">Another action</a></li>
                        <li><a href="{!! url('#') !!}">Something else here</a></li>
                        <li class="divider"></li>
                        <li><a href="{!! url('#') !!}">Separated link</a></li>
                      </ul>
                    </div>
                    ...
                    <div class="box-body">
                      ...
                      <div class="direct-chat-messages">
                        ...
                        <div class="direct-chat-msg">
                          ...
                          <img class="direct-chat-img" src="{!! asset('theme_components/admin/dist/img/user1-128x128.jpg') !!}" alt="message user image"><!-- /.direct-chat-img -->
                      ...
                      <div class="direct-chat-contacts">
                        <ul class="contacts-list">
                          ...
                          <li>
                            <a href="{!! url('#') !!}">
                              <img class="contacts-list-img" src="{!! asset('theme_components/admin/dist/img/user1-128x128.jpg')  !!}">
                  ...
                  <div class="box box-danger">
                    ...
                    <div class="box-body no-padding">
                      <ul class="users-list clearfix">
                        ...
                        @for($i=0; $i<7; $i++)
                        <li>
                          <img src="{!! asset('theme_components/admin/dist/img/user1-128x128.jpg') !!}" alt="User Image">
                          <a class="users-list-name" href="{!! url('#') !!}">Alexander Pierce</a>
                  ...
                  <ul class="products-list product-list-in-box">
                    ...
                    <li class="item">
                      <div class="product-img">
                        <img src="{!! asset('theme_components/admin/dist/img/default-50x50.gif') !!}" alt="Product Image">
                      </div>
